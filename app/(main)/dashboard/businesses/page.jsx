...
export default function BusinessDashboard() {
  ...
  return (
    <div className="flex min-h-screen flex-col ml-2 mr-2">
  ...
  <div className="flex justify-between items-center mb-4">
    <TabsList>
      <TabsTrigger 
        value="overview" 
        className="hover:bg-gray-100 hover:border-b-2 hover:border-blue-500 rounded-md transition duration-200"
      >
        Overview
      </TabsTrigger>
      <TabsTrigger 
      ...
      <TabsTrigger 
        value="crisis" 
        className="hover:bg-gray-700  rounded-md transition duration-200"
      >
        Crisis Management
      </TabsTrigger>
      <TabsTrigger 
      ...
      <div className="flex items-center gap-2">
        <Button
          variant="outline"
          size="sm"
          className="border hover:border-blue-500 transition duration-300"
        >
          <RefreshCw className="mr-2 h-4 w-4 hover:text-blue-500 transition duration-300" />
          Refresh Data
        </Button>
        <Button
          variant="outline"
          ...
          className="border hover:border-blue-500 transition duration-300"
        >
          <Download className="mr-2 h-4 w-4 hover:text-blue-500 transition duration-300" />
          Export
        </Button>
        <Button
          size="sm"
          className="border hover:border-blue-500 transition duration-300"
        >
          <Plus className="mr-2 h-4 w-4 hover:text-blue-500 transition duration-300" />
          New Report
        </Button>
      </div>
    </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <ThumbsUp className="h-4 w-4 text-green-500 hover:text-green-400 transition duration-300" />
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <AlertTriangle className="h-4 w-4 text-amber-500 hover:text-amber-400 transition duration-300" />
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <TrendingUp className="h-4 w-4 text-green-500 hover:text-green-400 transition duration-300" />
          </CardHeader>
          <CardContent>
